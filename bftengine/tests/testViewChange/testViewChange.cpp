...
void setUpConfiguration_4() {
  ...
  // replicaConfig[0].publicKeysOfReplicas.insert(std::pair(1, "dummpy key"));
  ...
  sigManager_.reset(createSigManager(0, replicaConfig[0].replicaPrivateKey, replicaConfig[0].publicKeysOfReplicas));
}
